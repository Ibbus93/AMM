	...
	?>
		            ...
		            <div class='box-article'>
		    			...
		    			--><div class='name-article'>
		    				<h3><nobr><a class='art-link' href='index.php?page=netbook&art=<?php echo"{$list[$i]->getCode()}";?>' alt='<?php echo "{$list[$i]->getMarca()} {$list[$i]->getModello()}";?>'><?php echo "{$list[$i]->getMarca()} {$list[$i]->getModello()}";?></a></nobr></h3> <!-- marca e modello-->
